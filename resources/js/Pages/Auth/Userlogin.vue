...
<Flash/>
    ...
    <h2 class="intro-x font-bold text-2xl xl:text-3xl text-center xl:text-left">
                        ...
                        <div v-for="(err , index) in form.errors" :key="index" class="mt-3 list-disc list-inside text-sm text-red-600">
                            {{err}}
                        </div>
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            ...
                            <button class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top" @click="reset">Reset</button>
